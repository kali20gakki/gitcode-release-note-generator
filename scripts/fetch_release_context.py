...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix=f"{repo}-release-context-") as temp_root:
        staging_dir = Path(temp_root) / final_output_dir.name
        ...
        log_file = staging_dir / "fetch.log"
        write_text(log_file, "")
        ...
        print(f"Fetched release context into: {final_output_dir}")
